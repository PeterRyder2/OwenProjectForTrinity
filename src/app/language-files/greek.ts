        ...
        hearing: {
            chapterDescription: {
                firstPage: {
                    ...
                    secondParagraph: `Στο ερωτηματολόγιο θα απαντήσετε ερωτήσεις σχετικά με την ακοή σας.`,
        ...
        vision: {
            ...
            testDescription: {
                ...
                secondPage: {
                    ...
                    secondParagraph: ``,
                    bankCardHint: `Συγκρίνετε το μέγεθος<br>με την τραπεζική<br>σας κάρτα`,
                    firstHint: `Πατήστε συνέχεια όταν το ορθογώνιο έχει το ίδιο πλάτος με την κάρτα.`
                },
                thirdPage: {
                    title: `Oδηγίες τεστ οράσεως`,
